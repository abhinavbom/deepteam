...
| NIST AI RMF                                | `NIST`           | `measurement_methods`, `validity_reliability`, `safety`, `security_resilience`, `privacy`, `fairness_bias`, `emergent_risk`, `impact_transparency` | Prompt-testable NIST AI RMF MEASURE subcategories: validity, safety, security, privacy, fairness, emergent risk, transparency |
...
The NIST AI RMF framework maps to eight prompt-testable MEASURE categories (`measurement_methods` through `impact_transparency`), each pinned to a NIST AI RMF MEASURE subcategory.
